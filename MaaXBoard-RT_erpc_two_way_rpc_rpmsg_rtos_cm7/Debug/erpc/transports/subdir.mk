...
CPP_SRCS += \
../erpc/transports/erpc_rpmsg_lite_rtos_transport.cpp 

CPP_DEPS += \
./erpc/transports/erpc_rpmsg_lite_rtos_transport.d 

OBJS += \
./erpc/transports/erpc_rpmsg_lite_rtos_transport.o 


# Each subdirectory must supply rules for building sources it contributes
erpc/transports/%.o: ../erpc/transports/%.cpp erpc/transports/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-erpc-2f-transports

clean-erpc-2f-transports:
	-$(RM) ./erpc/transports/erpc_rpmsg_lite_rtos_transport.d ./erpc/transports/erpc_rpmsg_lite_rtos_transport.o

.PHONY: clean-erpc-2f-transports
